...
echo "🎨 Creating custom Keycloak theme with CSP override..."
...
echo "📂 Custom theme location: $THEME_DIR"
echo ""
echo "🔧 To use this theme, add the following volume mount to your Keycloak service in docker-compose.yml:"
echo "    volumes:"
...
echo ""
echo "✅ Custom theme with CSP override created!"