-- Manual Notifications Migration
-- Run this script directly against your PostgreSQL database
-- This creates the notifications system if it doesn't already exist
...
SELECT COUNT(*) as notification_table_exists FROM information_schema.tables WHERE table_name = 'notifications';
